...
\runsubsection{Ted Talk}
\descript{| Invited as a Speaker}
...
\location{ May 2019 | Montreal, Quebec, Canada}
...
\runsubsection{California Institute of Technology (Caltech), Stanford University}
\descript{|Deep Learning for Biological imaging}
\location{May 2018|Pasadena,California,USA}
...
\location{June 2017|Cambridge,Massachusetts,USA}
\begin{wrapfigure}{l}{0.20\textwidth}
  \begin{center}
...
\descript{|Selected Speaker by FOSSEE}
\location{29 to 30 November 2017| Powai India}
\begin{wrapfigure}{l}{0.20\textwidth}
  \begin{center}
